...
_BRIEF_KEYWORDS = {
    ...
    "brief me", "draft brief", "generate a brief", "generate governance",
    "brief", "report", "summarize", "summarise", "document this",
    "save this", "export this", "finalize", "finalise",
}

# Words that always mean BRIEF — bypass vagueness gate
_BRIEF_OVERRIDE = {"brief", "report", "summarize", "summarise"}
...
def route_intent(state: AgentState) -> AgentState:
    ...
    # Check BRIEF intent FIRST — before vagueness gate
    # "generate brief", "brief", "report" etc. must never be caught by vagueness gate
    quick_intent = _keyword_classify(user_input)
    if quick_intent == "BRIEF":
        return {
            **state,
            "intent":         "BRIEF",
    ...
    # Keyword classification for all other intents
    intent = quick_intent
